...
import { BindingsDetailsModalComponent } from './bindings-details-modal.component';
...
describe('BindingsDetailsModalComponent', () => {
  let component: BindingsDetailsModalComponent;
  let fixture: ComponentFixture<BindingsDetailsModalComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BindingsDetailsModalComponent, '')
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(BindingsDetailsModalComponent);
