...
Contract with [OSBA](https://www.openservicebrokerapi.org/) is available in the [OSBAContract.md](https://github.com/kyma-project/kyma/tree/master/docs/service-catalog/docs/061-ui-catalog.md) document.
