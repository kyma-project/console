...
describe('LogsLink', () => {
  it('Labels should render with labels', () => {
    ...
    const domain = 'domain.io';
    const expectedHref =
      'https://grafana.domain.io/explore?left=[%22now-1h%22,%22now%22,%22Loki%22,{%22expr%22:%22{namespace=\\%22default\\%22}%22},{%22mode%22:%22Logs%22},{%22ui%22:[true,true,true,%22none%22]}]';
