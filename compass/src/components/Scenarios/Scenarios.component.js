...
class Scenarios extends React.Component {
    ...
    render() {
        ...
        const loading = scenarioLabelDefinitionSchemaQuery && scenarioLabelDefinitionSchemaQuery.loading;
        const error = scenarioLabelDefinitionSchemaQuery && scenarioLabelDefinitionSchemaQuery.error;
